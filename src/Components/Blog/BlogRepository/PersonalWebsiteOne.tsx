...
const CreatingPersonalWebsiteOne = () => {
  return (
    <div className="text-lg max-w-3xl mx-4 md:mx-auto">
      <div className="text-3xl mb-8 mt-8 text-center">
        Creating a Personal Website, Part 1{" "}
        <span className="text-red-600">(In Progress)</span>
      </div>
      <img src={SandBook} alt="Sandbook" />
      <div className="text-2xl text-blue-700 mb-8 mt-8 text-center">Idea</div>
      ...
      <div>
        ...
        the sand you're sculpting. To sufficently saturate the water and make it
        sturdy enough to sculpt and hold shape you need to pour water on top of
        the open bucket (or cardboard box) that holds the sand in, wait for it
        to settle, and then repeat several times.
        <br />
        <br />
      </div>
    </div>
